...
COS_API_KEY_ID="_K2E2aDEQTKeT_uvsUqSgD_bTb5CM4HgfeTKkN6lBRKV"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/750f25d0b289495689b53f6384409a6e:6a4dce49-d389-46e8-aa1e-85a3da52514e::"
...
@app.route('/')
def index():
    files = get_bucket_contents('object566')
